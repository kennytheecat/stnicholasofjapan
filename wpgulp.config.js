...
module.exports = {
	...
	// Style options.
	styleSRC: './_dev/css/sass/style.scss', // Path to main .scss file.
	...
	// Images options.
	imgSRC: './_dev/images/*.*/', // Source folder of images which should be optimized and watched. You can also specify types e.g. raw/**.{png,jpg,gif} in the glob.
